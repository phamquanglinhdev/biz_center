...
@section("content")
    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
        <h4 class="mb-sm-0">Sửa {{$entry->label}}</h4>

        <div class="page-title-right">
            <ol class="breadcrumb m-0">
                <li class="breadcrumb-item"><a href="javascript: void(0);">{{$entry->label}}</a></li>
                <li class="breadcrumb-item active">Sửa {{$entry->label}}</li>
            </ol>
        </div>
    </div>
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-9 col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{route("backend.".$entry->name.".update",$entry->id)}}" method="post" enctype="multipart/form-data">
                            @method("PUT")
                            @csrf
