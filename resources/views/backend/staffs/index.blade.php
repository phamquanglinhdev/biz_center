...
@section("right_tab")
    <form action="#" class="p-1">
        <div class="h4">Lọc danh sách nhân viên</div>
        <hr>
        <div class="mb-3">
        ...
        <div class="mb-3">
            <label for="name" class="form-label">Lọc theo chức vụ</label>
            <input name="job" type="text" class="form-control" id="phone" placeholder="Sales..."
                   value="{{$_REQUEST["job"]??""}}">
        </div>
        <div class="mb-3">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <hr>
                    <a class="btn btn-primary" href="{{route("backend.staffs.create")}}">
                        <i class="la la-plus-circle"></i>Thêm nhân viên mới
                    </a>
                    <a class="btn btn-primary" data-bs-toggle="offcanvas" href="#right_tab" role="button"
                       aria-controls="offcanvasExample">
                        <i class="la la-filter"></i> Lọc
                    </a>
                    <a class="btn btn-success" href="{{route("backend.staffs.index")}}" role="button">
                ...
                <div class="card-body bg-white">
                    <table class="border table table-hover nowrap rounded mt-2"
                        ...
                        <tr class="bg-primary text-white">
                            <th scope="col" class="bg-primary text-white">Mã nhân viên</th>
                            <th scope="col" class="bg-primary text-white">Tên nhân viên</th>
                            <th scope="col" class="bg-primary text-white">Chức vụ</th>
...
@section("table_init")
    <script>
        ...
        const tableCols = [
            {data: 'code', name: "Mã nhân viên"},
            {data: 'name', name: "Tên nhân viên"},
            {data: 'job', name: "Chức vụ"},
