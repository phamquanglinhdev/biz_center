                ...
                <div class="card">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb p-3 py-2 mb-0">
                            ...
                            <li class="breadcrumb-item"><a class="h6 text-primary" href="{{route("backend.staffs.index")}}">nhân viên</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Chỉnh sửa thông tin nhân viên {{$old->name}}</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <form action="{{route("backend.staffs.update",$old->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3 mt-3">
                                    ...
                                    <input type="text" name="job" value="{{$old->job??null}}" class="form-control"
                                           id="job">
                                </div>
                                <div class="col-md-6 mb-3">
