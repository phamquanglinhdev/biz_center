...
<head>
    <meta charset="utf-8"/>
    <title>Bizsoft Giải pháp quản lý trung tâm chuyên nghiệp</title>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown topbar-head-dropdown ms-1 header-item" id="notificationDropdown">
                        <button type="button" class="btn btn-icon btn-topbar btn-ghost-primary rounded-circle"
                            ...
                            <span
                                class="position-absolute topbar-badge fs-9 translate-middle badge rounded-pill bg-danger">3<span
                                    class="visually-hidden">thông báo chưa đọc</span></span>
                        </button>
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                                ...
                                <div class="p-3 bg-primary bg-pattern">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-auto dropdown-tabs">
                                            <span class="badge badge-soft-light fs-13"> 4</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="pt-2">
                                    <div data-simplebar style="max-height: 300px;" class="pe-2">
                                        ...
                                        <div class="my-3 text-center view-all">
                                            <button type="button"
                                                    class="btn btn-soft-success btn-sm waves-effect waves-light">View
                    ...
                    <div class="dropdown header-item">
                        ...
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block fw-medium user-name-text fs-16">Calvin D. <i
                                        class="las la-angle-down fs-12 ms-1"></i></span>
                            </span>
                        </span>
                        </button>
                        <div class="dropdown-menu dropdown-menu-end">
                            <!-- item-->
                            <a class="dropdown-item" href="#"><i class="bx bx-user fs-15 align-middle me-1"></i> <span
                                    key="t-profile">Profile</span></a>
                            <a class="dropdown-item" href="#"><i class="bx bx-wallet fs-15 align-middle me-1"></i> <span
                                    key="t-my-wallet">My Wallet</span></a>
                            <a class="dropdown-item d-block" href="#"><span class="badge bg-success float-end">11</span><i
                                    class="bx bx-wrench fs-15 align-middle me-1"></i> <span
                                    key="t-settings">Settings</span></a>
                            <a class="dropdown-item" href="#"><i
                                    class="bx bx-lock-open fs-15 align-middle me-1"></i> <span key="t-lock-screen">Lock screen</span></a>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="text-sm-end d-none d-sm-block">
                            Design & Develop by DangK and PhamQuangLinh
                        </div>
                    </div>
                </div>
            </div>
...
<div id="preloader">
    <div id="status">
        <div class="spinner-border text-primary avatar-sm" role="status">
            <span class="visually-hidden">Bizsoft...</span>
        </div>
    </div>
</div>
...
<div class="offcanvas offcanvas-end border-0" tabindex="-1" id="theme-settings-offcanvas">
    ...
    <div class="offcanvas-body p-0">
        <div data-simplebar class="h-100">
            <div class="p-4">
                ...
                <p class="text-muted">Chọn layout</p>
                ...
                <div class="row">
                    <div class="col-4">
                        ...
                        <h5 class="fs-13 text-center mt-2">Dọc</h5>
                    </div>
                    <div class="col-4">
                        <div class="form-check card-radio">
                        ...
                        <h5 class="fs-13 text-center mt-2">Ngang</h5>
                    </div>
                    <!-- end col -->
                </div>

                <h6 class="mt-4 mb-0 fw-semibold text-uppercase">Giao diện</h6>
                <p class="text-muted">Tối hoặc sáng.</p>
                ...
                <div id="layout-width">
                    <h6 class="mt-4 mb-0 fw-semibold text-uppercase">Kiểu layout rộng</h6>
                    <p class="text-muted">Chọn Fluid hoặc Boxed layout.</p>
                ...
                <div id="layout-position">
                    <h6 class="mt-4 mb-0 fw-semibold text-uppercase">Vị trí layout</h6>
                    <p class="text-muted">Chọn Cố định hoặc Cuộn.</p>
                ...
                <h6 class="mt-4 mb-0 fw-semibold text-uppercase">Màu topbar</h6>
                <p class="text-muted">Chọn sáng hoặc tối.</p>
                ...
                <div id="sidebar-size">
                    <h6 class="mt-4 mb-0 fw-semibold text-uppercase">Kích thước sizebar</h6>
                    <p class="text-muted">Chọn kích thước sizebar.</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            ...
                            <h5 class="fs-13 text-center mt-2">Lớn</h5>
                        </div>
                        ...
                        <div class="col-4">
                            ...
                            <h5 class="fs-13 text-center mt-2">Nhỏ (kiểu hover)</h5>
                        </div>
                    </div>
                </div>
    ...
    <div class="offcanvas-footer border-top p-3 text-center">
        <div class="row">
            ...
            {{--            <div class="col-6">--}}
            {{--                <a href="https://1.envato.market/Invoika-admin" target="_blank" class="btn btn-primary w-100">Buy--}}
            {{--                    Now</a>--}}
            {{--            </div>--}}
        </div>
    </div>
