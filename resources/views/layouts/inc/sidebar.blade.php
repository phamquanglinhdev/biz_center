        ...
        <li class="nav-item">
            ...
            <div class="collapse menu-dropdown" id="users">
                <ul class="nav nav-sm flex-column">
                    <li class="nav-item">
                        <a href="{{route("backend.staffs.index")}}" class="nav-link" data-key="t-user">Nhân viên</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{route("backend.students.index")}}" class="nav-link" data-key="t-user">Học sinh</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{route("backend.teachers.index")}}" class="nav-link" data-key="t-user">Giáo viên</a>
                    </li>
                </ul>
            </div>
        </li>
