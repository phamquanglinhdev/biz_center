!function () {
    var a, o, s, d, t, n, e, l, r, i, m, c = document.querySelector(".navbar-menu").innerHTML, u = 5, g = "en",
    ...
    function E() {
        "vertical" == document.documentElement.getAttribute("data-layout") && (document.querySelector(".navbar-menu") && (document.querySelector(".navbar-menu").innerHTML = c), document.getElementById("scrollbar").setAttribute("data-simplebar", ""), document.getElementById("navbar-nav").setAttribute("data-simplebar", ""), document.getElementById("scrollbar").classList.add("h-100")), "horizontal" == document.documentElement.getAttribute("data-layout") && k()
    }
    ...
    function S(e) {
        ...
        } else if (1 == p(e.target.parentElement.nextElementSibling) && 1848 <= window.innerWidth) for (var a = document.getElementsByClassName("dropdown-custom-right"); 0 < a.length;) a[0].classList.remove("dropdown-custom-right");
        ...
        } else if (1 == p(e.target.nextElementSibling) && 1848 <= window.innerWidth) for (a = document.getElementsByClassName("dropdown-custom-right"); 0 < a.length;) a[0].classList.remove("dropdown-custom-right")
    }
    ...
    function k() {
        ...
        var a = u, o = document.querySelectorAll("ul.navbar-nav > li.nav-item"), n = "", s = "";
